...
public class NavigationSidebar extends Section {
    ...
    @XPath(".//*[@ui='label' and contains(.,'Service')]") public Label service;
    ...
    @XPath(".//*[@ui='label' and contains(.,'Performance')]") public Label performance;
    @XPath(".//*[@ui='label' and contains(.,'Metals & Colors')]") public Label metalsColors;
    @XPath(".//*[@ui='label' and contains(.,'HTML 5')]") public Label hTML5;
    @XPath(".//*[@ui='label' and contains(.,'Bootstrap')]") public Label bootstrap;
